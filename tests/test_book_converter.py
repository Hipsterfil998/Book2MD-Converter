...
class TestRunPdfLlm:
    ...
    def _run(self, tmp_path, filenames: list[str]) -> list:
        ...
        with patch("book2md.pipeline.PDFToMarkdownConverter", Converter):
...
class TestRunEpubLlm:
    ...
    def _run(self, tmp_path, filenames: list[str]) -> list:
        ...
        with patch("book2md.pipeline.EpubToMarkdownConverter", Converter):
...
class TestRunSimple:
    def test_finds_pdf_and_epub(self, tmp_path):
        ...
        with patch("book2md.pipeline.DocumentProcessor", FakeProcessor):
